...
(function(){
  ...
  if(!document.getElementById('yms-parent-tabbar-style')){
    ...
    css.textContent=`
      ...
      .tab-bar{position:fixed!important;left:50%!important;bottom:0!important;transform:translateX(-50%)!important;width:min(100%,560px)!important;height:70px!important;padding:7px 5px calc(7px + env(safe-area-inset-bottom))!important;display:grid!important;grid-template-columns:repeat(5,minmax(0,1fr))!important;background:rgba(255,255,255,.98)!important;border-top:1px solid #E3E8F4!important;box-shadow:0 -4px 16px rgba(30,50,120,.06)!important;z-index:1000!important;backdrop-filter:blur(12px)!important}
