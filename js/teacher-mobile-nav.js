  ...
  if(!document.getElementById('yms-teacher-mobile-nav-style')){
    ...
    s.textContent=`
      ...
      @media(max-width:700px){
        ...
        body{padding-bottom:var(--yms-teacher-nav-safe)!important;min-height:100dvh!important}
        ...
        #teacherMobileNav{
          box-sizing:border-box;position:fixed;left:50%;bottom:0;transform:translateX(-50%);
          ...
          background:#fff;border-top:1px solid #E3E8F4;box-shadow:0 -3px 14px rgba(30,50,120,.05);z-index:99999;
        }
        #teacherMobileNav .tmn-btn{
          ...
          display:flex;flex-direction:column;align-items:center;justify-content:center;gap:5px;padding:4px 0;margin:0;min-width:0;
