...
(function(){
  ...
  function installFields(){
    ...
    if(!amount||document.getElementById('at_discountAmount')) return;
  ...
  window.onAdminTuitionStudentChange=function(){
    ...
    if(base&&amount){base.value=amount.value||0;document.getElementById('at_discountAmount').value=0;base.dispatchEvent(new Event('input'));}
  };
