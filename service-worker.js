/* YMS Master Track — Service Worker v3.19.0 */
const CACHE_NAME='yms-v3.19.0';
...
if(url.pathname.endsWith('/admin.html'))end=['js/admin-multirole-fix.js','js/admin-account-fix.js','js/account-id-migration.js','js/student-dashboard.js','js/admin-structure-fix.js','js/admin-menu-cleanup.js','js/student-select-options.js','js/parent-link-repair.js','js/parent-account-save-fix.js'];
...
if(url.pathname.endsWith('/parent-home.html'))pre=['js/parent-home-fix.js','js/notice-role.js'];
